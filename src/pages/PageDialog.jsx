...
const PageDialog = (NamaKarakter,Dialog,gambarkarakter,opsi,hari,background,alert) => {
    ...
    return (
        <div className='bg-black'>
            <img src={background} alt="" srcset="" className='absolute opacity-80 w-screen h-screen overflow-y-hidden' />
            ...
            <div className='relative bottom-14'>
                <div className="bottom-20 h-screen relative flex justify-center items-center">
                    ...
                    <img className="w-80" src={gambarkarakter} alt="" srcset="" />
                </div>
                ...
                <div className='relative bottom-56 bg-[#ffe680] shadow-multi-outline p-5 mx-36 rounded-2xl'>
                    ...
                    <div className="relative z-10 flex gap-10 mt-10">
                        <button className="button-56" role="button" onClick={handleButtonClick}>{opsi}</button>
                ...
                {alertVisible && (
                    <div className={`fixed top-20 left-5 bg-red-500 text-white p-4 rounded-lg transition-transform flex items-center gap-3 ${alertClass}`}>
                       <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path stroke-dasharray="64" stroke-dashoffset="64" d="M12 3l9 17h-18l9 -17Z"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.6s" values="64;0"/></path><path stroke-dasharray="6" stroke-dashoffset="6" d="M12 10v4"><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.6s" dur="0.2s" values="6;0"/></path><path stroke-dasharray="2" stroke-dashoffset="2" d="M12 17v0.01"><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.8s" dur="0.2s" values="2;0"/></path></g></svg>{alert}
                    </div>
                )}
            </div>
        </div>
